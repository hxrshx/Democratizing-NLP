...
from functionforDownloadButtons import ner_function
###################################
...
genre = st.multiselect(
    ...
    ('Standard Pre-Processing', 'Remove Digits', 'Remove Alphabets','Remove Alphanum','Retain only Alphanum','Remove Special Characters'),default = "Standard Pre-Processing")
...
st.write('You selected:', option_algo)
...
ner_text = st.text_input('Please enter the Text Input for performing NER', 'Enter text here')
ner_function(ner_text)
